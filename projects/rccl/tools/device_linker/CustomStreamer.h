...
///   User of CustomStreamer should call initialization code
///   for AsmPrinter:
///
...
class LLVM_ABI CustomStreamer : public DwarfEmitter {
public:
  CustomStreamer(DWARFLinkerBase::OutputFileType OutFileType,
                raw_pwrite_stream &OutFile,
                DWARFLinkerBase::MessageHandlerTy Warning)
      : OutFile(OutFile), OutFileType(OutFileType), WarningHandler(Warning) {}
  ~CustomStreamer() override = default;

  static Expected<std::unique_ptr<CustomStreamer>> createStreamer(
  ...
  Error init(Triple TheTriple, const char * CPU, const char * FeatureStr,
